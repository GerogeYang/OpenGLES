...
void Matrix::transposeM(float* mTrans, int mTransOffset, float* m, int mOffset)
{
    for (int i = 0; i < 4; i++)
    {
...
void Matrix::setLookAtM(float* rm, int rmOffset, float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ)
{
